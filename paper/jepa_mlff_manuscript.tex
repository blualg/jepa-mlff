...
\begin{figure}[t]
\centering
\includegraphics[width=0.82\linewidth]{../results/loss_curves_50.png}
\caption{\textbf{Validation force RMSE during supervised fine-tuning.} Validation force RMSE is shown for scratch and JEPA-initialized force fields across 50 supervised epochs. JEPA initialization reaches a lower best validation force RMSE (1.322) than the scratch baseline (1.596).}
